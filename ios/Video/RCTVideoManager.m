...
RCT_EXPORT_VIEW_PROPERTY(onVideoItemStart, RCTDirectEventBlock);
RCT_EXPORT_VIEW_PROPERTY(onVideoItemEnd, RCTDirectEventBlock);
RCT_EXPORT_VIEW_PROPERTY(onVideoQueueEnd, RCTDirectEventBlock);
